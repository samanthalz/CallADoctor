...
################################################################################
## Form generated from reading UI file 'view_clinicCUxHML.ui'
##
...
"text-align: center;")
        ...
        self.lineEdit.setGeometry(QRect(40, 40, 831, 71))
        font1 = QFont()
...
"")
        ...
        self.request_detail_outer.setGeometry(QRect(979, 200, 751, 831))
        ...
        self.clinic_details_inner.setGeometry(QRect(20, 20, 711, 791))
...
"max-height: 50px; /* Ensure the QLabel is a circle */")
        ...
        self.widget.setGeometry(QRect(3, 123, 701, 661))
        ...
        self.opening_hr_label = QLabel(self.widget)
        ...
        self.doc_label = QLabel(self.widget)
        ...
        self.doc_display = QLabel(self.widget)
        ...
        self.view_doc_btn = QPushButton(self.widget)
        ...
        self.date_req_label = QLabel(self.widget)
        ...
        self.date_req_display = QLabel(self.widget)
        ...
        self.comboBox = QComboBox(self.background)
        self.comboBox.addItem("")
        self.comboBox.addItem("")
        self.comboBox.setObjectName(u"comboBox")
        self.comboBox.setGeometry(QRect(710, 170, 151, 31))
        font7 = QFont()
...
"")
        self.clinicReq_frame_2 = QFrame(self.background)
        self.clinicReq_frame_2.setObjectName(u"clinicReq_frame_2")
        self.clinicReq_frame_2.setGeometry(QRect(60, 390, 801, 81))
...
"max-height: 50px; /* Ensure the QLabel is a circle */")
        ...
        self.label_2.setGeometry(QRect(690, 20, 91, 41))
        font9 = QFont()
...
"")
        ...
        self.clinicReq_frame = QFrame(self.background)
        self.clinicReq_frame.setObjectName(u"clinicReq_frame")
        self.clinicReq_frame.setGeometry(QRect(60, 290, 801, 81))
...
"max-height: 50px; ")
        ...
        self.label.setGeometry(QRect(690, 20, 91, 41))
...
"")
        ...
        font10.setBold(True)
        font10.setWeight(75)
        self.view_feedback_btn.setFont(font10)
...
"color: white;")
    ...
    def retranslateUi(self, Form):
        ...
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("Form", u"Search Clinic Name", None))
