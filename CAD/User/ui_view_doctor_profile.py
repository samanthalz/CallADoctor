...
"")
        ...
        self.profile_display_frame.setGeometry(QRect(60, 150, 1661, 691))
...
"color: white;")
    ...
    def retranslateUi(self, Form):
        ...
        self.speciality_display.setText(QCoreApplication.translate("Form", u"sample display", None))
        self.available_hour_label.setText(QCoreApplication.translate("Form", u"Available Hours", None))
        self.hour_display.setText(QCoreApplication.translate("Form", u"sample display", None))
        self.qualification_label.setText(QCoreApplication.translate("Form", u"Qualifications", None))
        self.qualification_display.setText(QCoreApplication.translate("Form", u"sample display", None))
