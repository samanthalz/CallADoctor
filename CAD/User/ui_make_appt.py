...
################################################################################
## Form generated from reading UI file 'make_apptuSFHXi.ui'
##
...
"")
        ...
        self.clinic_label = QLabel(self.widget)
...
"font-size: 11pt;")
        ...
        self.doc_dropdown = QComboBox(self.widget)
...
"font-size: 11pt;")
        ...
        self.time_dropdown = QComboBox(self.widget)
...
"font-size: 11pt;")
        ...
        self.speciality_dropdown = QComboBox(self.widget)
...
"font-size: 11pt;")
        ...
        self.med_label = QLabel(self.widget)
        ...
        self.med_dropdown = QComboBox(self.widget)
