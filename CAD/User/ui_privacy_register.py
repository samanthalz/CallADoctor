...
class PrivacyPolicyRegisterWidget(QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.policy_label = QLabel(self.whitebg)
        self.policy_label.setObjectName(u"policy_label")
        self.policy_label.setGeometry(QRect(60, 120, 481, 81))
        font = QFont()
        font.setFamily(u"Consolas")
        font.setPointSize(28)
        font.setBold(True)
        font.setWeight(75)
        self.policy_label.setFont(font)
...
"border-radius: 10px;")
    ...
    def retranslateUi(self, Form):
        ...
        self.policy_label.setText(QCoreApplication.translate("Form", u"Privacy Policy", None))
    ...
    def load_policy_from_db(self):
        ...
        try:
            ...
            if terms:
                ...
                self.textBrowser.setText("No policy found in the database.")
