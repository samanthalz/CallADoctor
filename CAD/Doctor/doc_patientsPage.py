...
# Form implementation generated from reading ui file 'doc_patientsPage.ui'
#
...
"color: white;")
    ...
    def retranslateUi(self, Form):
        ...
        self.patient_name_label1.setText(_translate("Form", "Patient Name"))
        self.patient_profile_logo1.setText(_translate("Form", "PN"))
        self.appt_time_label.setText(_translate("Form", "Time"))
        self.appt_date_label.setText(_translate("Form", "Date"))
