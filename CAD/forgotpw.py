...
from password_tools.password_reset import send_password_reset_link
    ...
    def emitContinue(self):
        ...
        if self.validateEmail():
            ...
            try : 
                ...
                send_success = send_password_reset_link(self.email)
            ...
            self.continue_successful.emit() # to redirect to login page
